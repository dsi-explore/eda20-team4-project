...
To make sense of the location of each job, we are grouping specific cities into metro areas. There are metro areas in our data set. 
...
Now we want to add the cost of living index for each obseravtion based on metro area.
